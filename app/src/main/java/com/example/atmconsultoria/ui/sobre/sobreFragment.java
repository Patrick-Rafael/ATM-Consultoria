...
public class sobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String descricao = "A atm consultoria deseja ajuda empresas a chegar a sua execelencia atrásves de gestão ";
        ...
        return new AboutPage(getActivity())
                ...
                .addFacebook("patrick.rafael.1004", "Facebook")
                .addInstagram("patrickrafaelborges/", "Instagram")
                .addItem( versao )
                .create();
