...
public class MainActivity extends AppCompatActivity {
    ...
    public void enviarEmail() {
        ...
        String endereco = "https://all.accor.com/magazine/imagerie/ferias-na-praia-o-que-fazer-das-f163.jpg";

       // Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel: 22992782916"));
        ...
        startActivity( Intent.createChooser( intent, "Compartilhar E-mail " ));
